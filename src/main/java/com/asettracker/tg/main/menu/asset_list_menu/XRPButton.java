...
@Component
@AllArgsConstructor
public class XRPButton implements IAssetListMenuButton {

    private static final String XRP_BUTTON_CALLBACK_DATA = "xrpButton";
    ...
    public InlineKeyboardButton getButton() {
        return InlineKeyboardButton.builder()
                .text("XRP")
                .callbackData(XRP_BUTTON_CALLBACK_DATA)
                .build();
    }

    @Override
    public boolean canHandleButton(Update update) {
        return update.getCallbackQuery().getData().equals(XRP_BUTTON_CALLBACK_DATA);
    }

    @Override
    public void handleButton(Update update) {
        userChoose.setCoinName("XRP");
